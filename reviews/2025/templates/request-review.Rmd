...
If you do not respond to this message by **`r params$date`**, we will assume you no longer need access and remove you from the organisation. You will be able to [request to re-join](https://github.com/ScotGovAnalysis/welcome/issues/new?template=new-member-request.yml) if your circumstances change in the future.
